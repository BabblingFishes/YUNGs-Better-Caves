...
public abstract class CubicChunksAbstractBC {
    private World world;
    private long seed;
     ...
     */
    public CubicChunksAbstractBC(World world, int fOctaves, float fGain, float fFreq, int numGens, float threshold, int tOctaves,
